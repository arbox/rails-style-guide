...
* <a name="foreign-key-constraints"></a>
  Устанавливайте ограничения на вторичные ключи. Начиная с `Rails 4.2`
  библиотека `ActiveRecord` поддерживает вторичные ключи напрямую.
...
но дефектных библиотеках, то проинформируйте нас.
